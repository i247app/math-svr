...
// Generate 5 multiple-choice math questions for %s %s where the grade has 4 semester level of difficulty.
...
var PromptForGenerateQuizPractice = `
Generate 5 multiple-choice math questions for Vietnam %s %s where the grade has 4 semester level of difficulty.
