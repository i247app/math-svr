...
type IUserService interface {
	...
	GetUserByID(ctx context.Context, id int64) (status.Code, *dto.UserResponse, error)
	...
	DeleteUser(ctx context.Context, uid int64) (status.Code, error)
	ForceDeleteUser(ctx context.Context, uid int64) (status.Code, error)
}
