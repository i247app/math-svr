...
func (i *Invitation) SetInvitationId(id string)                { i.invitationId = id }
func (i *Invitation) ClassroomId() string                      { return i.classroomId }
func (i *Invitation) SetClassroomId(id string)                 { i.classroomId = id }
func (i *Invitation) InviterProfileId() string                 { return i.inviterProfileId }
func (i *Invitation) SetInviterProfileId(id string)            { i.inviterProfileId = id }
func (i *Invitation) InvitedProfileId() *string                { return i.invitedProfileId }
func (i *Invitation) SetInvitedProfileId(v *string)            { i.invitedProfileId = v }
...
func (i *Invitation) ResponseProfileId() *string               { return i.responseProfileId }
func (i *Invitation) SetResponseProfileId(v *string)           { i.responseProfileId = v }
func (i *Invitation) CancelledByProfileId() *string            { return i.cancelledByProfileId }
func (i *Invitation) SetCancelledByProfileId(v *string)        { i.cancelledByProfileId = v }
...
func (i *Invitation) CreateId() *string                        { return i.createId }
func (i *Invitation) SetCreateId(id *string)                   { i.createId = id }
func (i *Invitation) CreateDt() mtime.MathTime                 { return i.createDt }
func (i *Invitation) SetCreateDt(t mtime.MathTime)             { i.createDt = t }
func (i *Invitation) ModifyId() *string                        { return i.modifyId }
func (i *Invitation) SetModifyId(id *string)                   { i.modifyId = id }
