...
func (t *ProgramTranslation) ProgramTranslationId() string      { return t.programTranslationId }
func (t *ProgramTranslation) SetProgramTranslationId(id string) { t.programTranslationId = id }
func (t *ProgramTranslation) ProgramId() string                 { return t.programId }
func (t *ProgramTranslation) SetProgramId(id string)            { t.programId = id }
...
func (t *ProgramTranslation) CreateId() *string                 { return t.createId }
func (t *ProgramTranslation) SetCreateId(id *string)            { t.createId = id }
...
func (t *ProgramTranslation) ModifyId() *string                 { return t.modifyId }
func (t *ProgramTranslation) SetModifyId(id *string)            { t.modifyId = id }
