...
func (t *SemesterTranslation) SemesterTranslationId() string      { return t.semesterTranslationId }
func (t *SemesterTranslation) SetSemesterTranslationId(id string) { t.semesterTranslationId = id }
func (t *SemesterTranslation) SemesterId() string                 { return t.semesterId }
func (t *SemesterTranslation) SetSemesterId(id string)            { t.semesterId = id }
...
func (t *SemesterTranslation) CreateId() *string                  { return t.createId }
func (t *SemesterTranslation) SetCreateId(id *string)             { t.createId = id }
...
func (t *SemesterTranslation) ModifyId() *string                  { return t.modifyId }
func (t *SemesterTranslation) SetModifyId(id *string)             { t.modifyId = id }
