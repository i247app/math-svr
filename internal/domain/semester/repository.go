...
type IRepository interface {
	FindBySemesterId(ctx context.Context, semesterId string, language enum.LanguageType) (*Semester, error)
	...
	SoftDeleteBySemesterId(ctx context.Context, semesterId string) error
	ForceDeleteBySemesterId(ctx context.Context, semesterId string) error
}
...
type ITranslationRepository interface {
	ListBySemesterId(ctx context.Context, semesterId string) ([]*SemesterTranslation, error)
	FindBySemesterIdAndLanguage(ctx context.Context, semesterId string, language string) (*SemesterTranslation, error)
	...
	SoftDeleteBySemesterId(ctx context.Context, semesterId string) error
	SoftDeleteByTranslationId(ctx context.Context, semesterTranslationId string) error
	ForceDeleteBySemesterId(ctx context.Context, semesterId string) error
	ForceDeleteByTranslationId(ctx context.Context, semesterTranslationId string) error
}
