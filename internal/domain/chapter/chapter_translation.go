...
func (t *ChapterTranslation) ChapterTranslationId() string  { return t.chapterTranslationId }
func (t *ChapterTranslation) SetChapterTranslationId(id string) {
	t.chapterTranslationId = id
}
func (t *ChapterTranslation) ChapterId() string         { return t.chapterId }
func (t *ChapterTranslation) SetChapterId(id string)    { t.chapterId = id }
...
func (t *ChapterTranslation) CreateId() *string         { return t.createId }
func (t *ChapterTranslation) SetCreateId(id *string)    { t.createId = id }
...
func (t *ChapterTranslation) ModifyId() *string         { return t.modifyId }
func (t *ChapterTranslation) SetModifyId(id *string)    { t.modifyId = id }
