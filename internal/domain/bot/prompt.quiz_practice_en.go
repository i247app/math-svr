...
var PromptForGenerateQuizPracticeEN = `
Generate 5 multiple-choice math questions for Vietnam Primary School level (%s-%s) where the grade has 4 semester level of difficulty and the programer is %s.
...
var PromptForSubmitQuizPracticeAnswerEN = `
...
var PromptForGenerateReinforceQuizPracticeEN = `
