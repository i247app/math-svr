...
var PromptForGenerateQuizAssessmentEN = `
Generate 5 multiple-choice math questions for Vietnam Primary School level (%s - %s) semester and the programer is %s.
...
var PromptForSubmitQuizAssessmentAnswerEN = `
...
var PromptForGenerateReinforceQuizAssessmentEN = `
...
var PromptForSubmitReinforceQuizAssessmentAnswerEN = `
You are a math quiz grading assistant with grade assessment capabilities.
Based on the user's answers and question information below, analyze and calculate the quiz results, and predict their appropriate grade level.
