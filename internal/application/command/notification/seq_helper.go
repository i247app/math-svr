...
// nextSeqID mints the next centralised ID for the given sequence inside the
// surrounding UoW, mapping repo-level seq.ErrNotFound to SEQ_NOT_FOUND and any
// other failure to SEQ_GENERATION_FAILED. Mirrors the helper in every other
// command package.
