CREATE TABLE IF NOT EXISTS ma_user_exams (
    ...
    r_total_questions   INT UNSIGNED    NULL,
    r_correct_number    INT UNSIGNED    NULL,
    r_score_percentage  INT UNSIGNED    NULL,
    r_review            TEXT            NULL,
    r_grade             BIGINT          NULL,
    r_level             BIGINT          NOT NULL,
    submitted_dt        DATETIME(6)     NULL,
